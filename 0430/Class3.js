...
function Class3(props) {
  return (
    <>
      ...
      <dl>
        <dt>웹서버 종류</dt>
        <dd>로컬컴퓨터 lacalhost:3000</dd>
        <dd>닷홈 서버</dd>
        <dd>깃허브 레포지토리</dd>
      </dl>
      <br />
      <h4>1. 로컬에서 실행(React 프로젝트 환경)</h4>
      <p>vs code에서 'npm run start'하면 build폴더가 생성되면서 파일이 생성됨.</p>
