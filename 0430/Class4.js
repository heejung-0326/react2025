...
function Class4(props) {
  return (
    <>
      <h3 className="title3">02_리액트에서 이미지 삽입하는 방법</h3>
      <ul>
      ...
      {/* 이미지 삽입 */}
      <img src={`${process.env.PUBLIC_URL}/images/logo.png`} alt="노랑풍선로고" /><br />
      <img src={item1} alt="여행상품"/><br />
      <img src={require('../images/item2.jpg')} alt="여행상품" />
      <p>jsx파일에서 절대경로는 public폴더를 기준으로함</p>
